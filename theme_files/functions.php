...
function buninoven_styles_child()
{
    // Register Child Styles
    wp_register_style('buninoven-child', get_stylesheet_directory_uri() . '/style.css', array(), '1.0', 'all');
    wp_register_style('child-all', get_stylesheet_directory_uri() . '/css/all.css', array(), '1.0', 'all');

    // Enqueue Child Styles
    wp_enqueue_style('buninoven-child'); 
...
add_action('wp_enqueue_scripts', 'buninoven_styles_child', 20); // Add Theme Child Stylesheet
